...
const CampaignDisplayPage = () => {
  ...
  if (
    ...
    currentCampaign!.data!.campaignPages
  ) {
      ...
      <Grid mt={100}>
        ...
        <Grid.Col xs={9} sm={10} md={10} lg={10}>
          {campaignPages.map((campaignPage, index) => {
            ...
            if (index % 2 == 0) {
              leftImg = (
                <Grid.Col xs={6} sm={4} md={4} lg={4}>
                  <Image
                    src={
                      "https://mantinetemplate.netlify.app/static/media/lime-surfing.8ef8682684832594f090.png"
                    }
                    alt={"sample1"}
                    style={{ width: "100%" }}
                  />
              ...
              rightImg = (
                <Grid.Col xs={6} sm={4} md={4} lg={4}>
                  <Image
                    src={
                      "https://mantinetemplate.netlify.app/static/media/lime-bicycle-riding.b6b8368f8cf9b17c988c.png"
                    }
                    alt={"sample1"}
                    style={{ width: "100%" }}
                  />
            ...
            return (
              <Container key={index} mb={100} size="xl">
