...
const PanelBuddyTeamListPage = () => {
  ...
  const { data: allBuddyTeams, isLoading: isBuddyTeamsLoading } =
    ...
    () => [
      {
        ...
        columns: [
          {
            accessorFn: (row) =>
              `${row.facilitator.user.name} ${row.facilitator.user.surname}`, //accessorFn used to join multiple data into a single cell
    ...
    return (
      ...
      >
        ...
        <Box sx={{ textAlign: "center" }}>
          ...
          <Text>
            &quot;{props.row.original.facilitator.user.biography}&quot;
          </Text>
        </Box>
      </Box>
    );
