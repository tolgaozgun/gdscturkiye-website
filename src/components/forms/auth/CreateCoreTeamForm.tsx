...
interface CreateCoreTeamFormProps {
...
const CreateCoreTeamForm = ({universityData}: CreateCoreTeamFormProps) => {
	...
	const onRegister = async () => {
		...
		notifications.show({
			...
			message:
				'You have successfully created a Core Team Member!',
			autoClose: 5000,
			withCloseButton: true,
...
export default CreateCoreTeamForm;
