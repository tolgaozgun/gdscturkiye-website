...
export const Layout = () => {
  ...
  if (checkLink("/panel/admin")) {
    ...
    navbar = (
      <PanelNavbar
        hidden={!opened}
        panelName="Lead Panel"
        panelData={LeadPanelData}
      />
    );
    header = (
      <PanelHeader
    ...
    navbar = (
      <PanelNavbar
        hidden={!opened}
        panelName="Facilitator Panel"
        panelData={FacilitatorPanelData}
      />
    );
    header = (
      <PanelHeader
    ...
    navbar = (
      <PanelNavbar
        hidden={!opened}
        panelName="Core Team Panel"
        panelData={CoreTeamPanelData}
      />
    );
    header = (
      <PanelHeader
    ...
    header = (
      <AppHeader
        user={user}
        tabs={tabs}
        isLoggedIn={!isUserError || !isUserLoading}
      />
    );
  }
